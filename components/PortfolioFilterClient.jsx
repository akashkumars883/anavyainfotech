            ...
            {project.image && (
              <div className="w-full h-48 overflow-hidden bg-stone-100 relative">
                ...
                {project.websiteUrl && (
                  ...
                  >
                    Live Site <ArrowUpRight className="h-3 w-3 text-blue-500" />
                  </a>
                )}
              </div>
            )}
            ...
            <div className="p-6 space-y-6 flex-1 flex flex-col justify-between text-left">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-blue-700 bg-blue-700/10 px-2.5 py-1 rounded-md border border-blue-700/20">
                    {project.category}
                  </span>
                  <span className="text-xs font-semibold text-stone-400">{project.year}</span>
                </div>

                <h2 className="text-xl font-bold tracking-tight text-stone-900 group-hover:text-blue-700 transition-colors">
              ...
              <div className="space-y-4 pt-4 border-t border-stone-200/60">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <ArrowUpRight className="h-3.5 w-3.5 text-blue-500 group-hover/btn:translate-x-0.5 transition-transform" />
                  </Link>
                  ...
                  {project.websiteUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-1 px-4 py-2.5 rounded-md bg-blue-700 text-white hover:bg-blue-800 transition-colors text-xs font-semibold shrink-0"
                    >
