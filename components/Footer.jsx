        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="space-y-6 text-left">
            ...
            <div className="space-y-3">
              ...
              {isSubscribed ? (
                <div className="flex items-center gap-2 text-sm font-semibold text-blue-600 animate-fade-in">
                  <Check className="h-4 w-4" />
                  <span>Subscribed successfully!</span>
                </div>
              ) : (
                <form onSubmit={handleSubscribe} className="flex bg-white/5 border border-white/10 rounded-md overflow-hidden p-1">
                  <input
                    type="email"
                    required
                  ...
                  <button
                    ...
                    className="p-2 rounded-md bg-white text-black hover:bg-zinc-200 transition-colors cursor-pointer"
                  >
