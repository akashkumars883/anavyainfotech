...
export default function Footer() {
  ...
  const links = {
    services: [
      ...
      { name: "Local SEO Agency", href: "/services/local-seo" },
    ],
    solutions: [
      { name: "E-Commerce & Retail", href: "/solutions/ecommerce-retail" },
      { name: "Healthcare & Medical", href: "/solutions/healthcare-medical" },
      { name: "Real Estate Portals", href: "/solutions/real-estate" },
      { name: "Fintech & Banking", href: "/solutions/fintech-finance" },
      { name: "Startups & MVP", href: "/solutions/startups-mvp" },
      { name: "Enterprise Systems", href: "/solutions/enterprise" },
    ],
    products: [
      { name: "Automixa AI", href: "https://www.automixa.in/", isExternal: true },
      { name: "Anaya AI Engine", href: "/services/ai-chatbot", isExternal: false },
    ],
    company: [
      ...
      { name: "Hire Next.js Developers", href: "/hire-nextjs-developers-india" },
      { name: "Offshore IT Outsourcing", href: "/offshore-software-development-company" },
  ...
  return (
    <footer className="bg-[#09090b] text-white border-t border-white/5 py-10 sm:py-16 px-4 sm:px-6 md:px-8 relative z-10">
      <div className="max-w-7xl mx-auto space-y-10 sm:space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 space-y-5 text-left">
            ...
            <p className="text-xs text-zinc-300 font-normal leading-relaxed max-w-sm">
            ...
            {/* Social Icons Connect (Facebook, Instagram, Pinterest, LinkedIn, Twitter X, Email) */}
            <div className="pt-1 space-y-2.5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="h-8 w-8 rounded-md bg-white/10 border border-white/15 flex items-center justify-center text-zinc-200 hover:text-white hover:bg-white/20 transition-all"
                >
            ...
            {/* Direct Contact Info */}
            <div className="pt-2 space-y-2 text-xs text-zinc-200 font-medium">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                  <a href="tel:+916201231875" className="hover:text-white transition-colors">+91 6201231875</a>
                  <span className="hidden sm:inline text-zinc-600">|</span>
                  <a href="tel:+917508657479" className="hover:text-white transition-colors">+91 7508657479</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 text-left">
            <h4 className="text-xs font-bold text-white uppercase tracking-widest border-b border-white/10 pb-1.5 sm:border-b-0 sm:pb-0">
              Services
            </h4>
            <ul className="space-y-2">
              {links.services.map((link, i) => (
                <li key={i}>
                  <Link
                    href={link.href}
                    className="text-xs text-zinc-300 hover:text-white transition-colors font-normal block py-0.5"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Links Column 3: Products */}
          <div className="space-y-3 text-left">
            <h4 className="text-xs font-bold text-white uppercase tracking-widest border-b border-white/10 pb-1.5 sm:border-b-0 sm:pb-0">
              Our Products
            </h4>
            <ul className="space-y-2">
              {links.products.map((link, i) => (
                <li key={i}>
                  {link.isExternal ? (
                    <a
                      href={link.href}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs text-blue-400 hover:text-blue-300 transition-colors inline-flex items-center gap-1 font-semibold py-0.5"
                    >
                      {link.name} ↗
                    </a>
                  ) : (
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10 space-y-3 text-left">
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <div className="text-xs font-medium text-zinc-400">
            &copy; {currentYear} Anavya Infotech. All rights reserved.
          </div>
