            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-6 text-left">
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-widest text-blue-700">
                    <span>{post.category}</span>
                    <span className="text-stone-400 font-light">{post.readTime}</span>
                  </div>
                  <h3 className="text-lg font-bold tracking-tight text-stone-900 leading-snug group-hover:text-blue-700 transition-colors">
                    {post.title}
                  </h3>
