...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      quote: "Anavya Infotech redesigned our entire CRM flow from scratch. Their technical design process and communication were outstanding, leading to a 40% reduction in agent operation times.",
              ...
              return (
                ...
                >
                  <div className="space-y-6">
                    ...
                    <Quote className="h-10 w-10 text-blue-700 opacity-25 transform rotate-180" />
