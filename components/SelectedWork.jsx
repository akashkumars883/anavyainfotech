                  ...
                  {project.websiteUrl && (
                    <object className="inline-block">
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-1 px-4 py-2.5 rounded-md bg-blue-700 text-white hover:bg-blue-600 transition-colors text-xs font-bold shrink-0"
                      >
