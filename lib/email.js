...
const smtpUser = process.env.SMTP_USER || process.env.ADMIN_EMAIL || "info@anavyainfotech.com";
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
            ...
            <div style="padding: 28px; color: #334155; font-size: 14px; line-height: 1.6;">
              ...
              <p style="margin-bottom: 0;">If you need urgent assistance, feel free to reply directly to this email or contact us at <strong>info@anavyainfotech.com</strong>.</p>
            </div>
