...
/**
 * Advanced TF-IDF & Semantic Context Extractor
 */
export function extractRelevantContext(knowledge, userQuestion) {
  ...
  // Score pages based on TF-IDF term frequency + title weights
