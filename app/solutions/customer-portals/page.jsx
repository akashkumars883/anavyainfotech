    ...
    <main className="min-h-screen bg-white pt-24 md:pt-20 text-left">
      ...
      <section className="py-10 bg-stone-50 border-b border-stone-100 px-6">
        <div className="max-w-7xl mx-auto space-y-6">
          <Breadcrumbs items={[{ label: "Solutions", href: "/#solutions" }, { label: "Customer Portals", href: "/solutions/customer-portals" }]} />
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-normal tracking-tight text-stone-900 leading-[1.1] max-w-5xl">
            Custom Customer <br />
            <span className="text-blue-700">Portal Development</span>
          </h1>
