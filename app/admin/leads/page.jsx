                ...
                {filteredLeads.map((lead, idx) => (
                  <tr key={lead.id || idx} className="hover:bg-stone-50/80 transition-colors">
                    <td 
                      ...
                      className="py-4 px-6 font-bold text-stone-900 hover:text-blue-700 cursor-pointer underline underline-offset-4 decoration-blue-300 hover:decoration-blue-700 transition-colors"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-stone-50 border border-stone-200 rounded-md p-3.5 space-y-1">
                  <span className="text-stone-400 block text-[10px] uppercase font-bold flex items-center gap-1">
                    <Globe className="h-3 w-3 text-stone-500" /> Source / Site ID
                  </span>
