...
export const metadata = {
  title: "Corporate Branding & Visual Identity Design | Anavya Infotech",
  description:
  ...
  alternates: {
    canonical: "https://anavyainfotech.com/services/branding",
  },
  openGraph: {
    title: "Corporate Branding & Visual Identity Design | Anavya Infotech",
    ...
    url: "https://anavyainfotech.com/services/branding",
    type: "website",
  },
};
      ...
      <section className="py-10 bg-stone-50 border-b border-stone-100 px-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white border border-stone-200 text-[11px] font-bold uppercase tracking-wider text-stone-600">
            <Palette className="h-3.5 w-3.5 text-blue-700" /> Services / Corporate Branding
          </div>
              ...
              >
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-xs font-semibold text-blue-700 uppercase tracking-wider">{pillar.tagline}</div>
                  </div>
