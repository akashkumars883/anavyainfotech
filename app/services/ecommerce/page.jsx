...
export const metadata = {
  ...
  description:
    "Anavya Infotech is a premier ecommerce development company in India offering headless ecommerce development services, custom Next.js storefronts, Shopify integrations, and payment gateway setups.",
  keywords:
    ...
    <main className="min-h-screen bg-white pt-6 md:pt-8 text-left selection:bg-blue-600/20 selection:text-blue-950">
      ...
      <section className="py-10 bg-stone-50 border-b border-stone-100 px-6">
        <div className="max-w-7xl mx-auto space-y-6">
          <Breadcrumbs items={[{ label: "Services", href: "/#services" }, { label: "Ecommerce", href: "/services/ecommerce" }]} />
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white border border-stone-200 text-[11px] font-bold uppercase tracking-wider text-stone-600">
            <ShoppingCart className="h-3.5 w-3.5 text-blue-700" /> Services / E-Commerce Development
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-normal tracking-tight text-stone-900 leading-[1.1] max-w-5xl">
            ...
            <span className="text-blue-700">Headless Storefront Engineering</span>
          </h1>
