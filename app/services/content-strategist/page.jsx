...
export const metadata = {
  ...
  alternates: {
    canonical: "https://anavyainfotech.com/services/content-strategist",
  },
  openGraph: {
    ...
    url: "https://anavyainfotech.com/services/content-strategist",
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-white pt-24 md:pt-20 text-left selection:bg-blue-600/20 selection:text-blue-950">
      ...
      <section className="py-10 bg-stone-50 border-b border-stone-100 px-6">
        <div className="max-w-7xl mx-auto space-y-6">
          <Breadcrumbs items={[{ label: "Services", href: "/#services" }, { label: "Content Strategist", href: "/services/content-strategist" }]} />
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white border border-stone-200 text-[11px] font-bold uppercase tracking-wider text-stone-600">
            <Megaphone className="h-3.5 w-3.5 text-blue-700" /> Services / Digital & Performance Marketing
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-normal tracking-tight text-stone-900 leading-[1.1] max-w-5xl">
            ...
            <span className="text-blue-700">Performance Marketing Company</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-stone-600 font-light max-w-3xl leading-relaxed">
            Anavya Infotech is a results-driven <strong>digital marketing company in India</strong>, <strong>Delhi NCR</strong>, and <strong>Noida</strong>. We deliver high-ROI <strong>performance marketing company services</strong> and targeted <strong>social media marketing services</strong>.
          </p>
        </div>
      </section>
