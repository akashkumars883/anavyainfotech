...
export const metadata = {
  title: "Terms of Service – Anavya Infotech",
  description:
    "Terms of Service and legal agreement governing custom software development, web engineering, AI automation, and technical SEO services by Anavya Infotech.",
  alternates: {
...
const TERMS_FAQS = [
  {
    ...
    answer:
      "These terms take effect upon accessing our website or executing a formal project proposal / statement of work (SOW) with Anavya Infotech.",
  },
  {
      ...
      <section className="py-10 bg-white px-6">
        <div className="max-w-4xl mx-auto space-y-10 text-stone-600 text-sm sm:text-base leading-relaxed font-light">
          <section className="space-y-4">
            ...
            <p>
              These Terms of Service (&quot;Terms&quot;) constitute a legally binding agreement between you (&quot;Client&quot;, &quot;User&quot;, or &quot;You&quot;) and Anavya Infotech (&quot;Company&quot;, &quot;We&quot;, or &quot;Us&quot;). By accessing our website or contracting our software engineering, website development, AI integration, CRM custom build, or SEO services, you agree to comply with and be bound by these Terms.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              Anavya Infotech provides custom software application development, website design and engineering, artificial intelligence workflow automation, search engine optimization, and enterprise consulting. Specific project deliverables, timelines, milestones, and fees will be governed by individual Master Services Agreements (MSA), Statements of Work (SOW), or project proposals executed between the Client and Company.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="p-6 rounded-md bg-stone-50 border border-stone-100 space-y-3">
              ...
              <p className="text-sm text-stone-700">
                Upon final payment of all agreed project milestone fees, Anavya Infotech assigns and transfers to Client all custom source code, application assets, designs, and intellectual property developed explicitly for the Client project.
              </p>
          ...
          <section className="space-y-4">
            ...
            <p>
              To the maximum extent permitted by applicable law, Anavya Infotech shall not be liable for any indirect, incidental, consequential, special, or punitive damages (including loss of profits, data loss, or business interruption) arising out of or related to the use or inability to use the software systems created.
            </p>
          </section>
