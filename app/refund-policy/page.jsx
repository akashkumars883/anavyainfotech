...
export const metadata = {
  title: "Cancellation & Refund Policy – Anavya Infotech",
  description:
      ...
      <section className="py-10 bg-stone-50 border-b border-stone-100 px-6">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white border border-stone-200 text-[11px] font-bold uppercase tracking-wider text-stone-600">
            <RefreshCw className="h-3.5 w-3.5 text-blue-700" /> Client Guarantee & Terms
          </div>
      ...
      <section className="py-10 bg-white px-6">
        <div className="max-w-4xl mx-auto space-y-10 text-stone-600 text-sm sm:text-base leading-relaxed font-light">
          ...
          <div className="pt-8 border-t border-stone-100 flex items-center justify-between">
            ...
            >
              Contact Customer Support <ArrowRight className="h-3.5 w-3.5 text-blue-700" />
            </Link>
            <Link 
