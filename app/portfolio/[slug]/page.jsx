...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.anavyainfotech.com/portfolio/${project.slug}`,
    },
    openGraph: {
      title: project.title,
      description: project.summary,
      url: `https://www.anavyainfotech.com/portfolio/${project.slug}`,
      type: "article",
    },
  };
}
...
export default async function CaseStudyPage({ params }) {
  ...
  return (
    <main className="min-h-screen bg-white pt-24 md:pt-20 pb-20 text-left selection:bg-blue-600/20 selection:text-blue-950">
      <script
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-12">
        ...
        <header className="space-y-6 border-b border-stone-200 pb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 p-6 rounded-md bg-stone-50 border border-stone-200">
            <div>
