            ...
            <div className="p-6 rounded-md bg-stone-50 border border-stone-100 space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="inline-flex items-center gap-2 px-3.5 py-2 rounded-md bg-white border border-stone-200 text-xs font-semibold text-stone-700 hover:text-blue-700 hover:border-orange-200 transition-all shadow-sm"
                >
